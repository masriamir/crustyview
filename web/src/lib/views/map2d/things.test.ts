...
describe('categoryOf', () => {
  ...
  it('maps starts, teleport destinations, and unknowns to other', () => {
    for (const id of [1, 2, 3, 4, 11, 14]) expect(categoryOf(id, null)).toBe('other');
...
describe('countByCategory', () => {
  it('totals per category, including zero entries', () => {
    const things = [{ type_id: 3001 }, { type_id: 3004 }, { type_id: 2001 }, { type_id: 1 }];

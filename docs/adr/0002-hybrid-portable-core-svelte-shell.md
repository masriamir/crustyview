...
- **Status:** Accepted
- **Amended by:** [ADR-0006](0006-webgl2-2d-renderer-succession.md) — TypeScript may
  target WebGL2 for the 2D map when measured performance demands it; `wgpu` and
  portable Rust remain 3D-only
- **Date:** 2026-08-05
